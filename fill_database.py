...
cat2 = Category(name="vegetables", description="Healthy and fresh!")
session.add(cat2)
session.commit()

cat3 = Category(name="cookies", description="Chocolate chip cookies, peanut\
 butter cookies, butter cookies, find them all here!")
session.add(cat3)
session.commit()
